...
$this->title = Yii::t('app','Costcode (eg. DIR - Direct Expenses)');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="costcategory-index">
    <h1><?= Html::encode($this->title) ?></h1>
    <?php //echo $this->render('_search', ['model' => $searchModel]); ?>
    <p>
        <?= Html::a(Yii::t('app','Create Costcode eg. DIR - Direct Expenses'), ['create'], ['class' => 'btn btn-success']) ?>
    </p>
    <?= ListView::widget([
