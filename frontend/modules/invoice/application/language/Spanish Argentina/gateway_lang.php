...
$lang = array(
    ...
    'online_payment_creditcard_hint'     => 'Si desea pagar con tarjeta de crédito, ingrese la información a continuación.<br/>La información de la tarjeta de crédito no se almacena en nuestros servidores y se transferirá a la pasarela de pagos en línea mediante una conexión segura.',
    'enable_online_payments'             => 'Habilitar los pagos en línea',
    ...
    'online_payment_apiLoginId'          => 'ID de inicio de sesión de Api', // Field for AuthorizeNet_AIM
    ...
    'online_payment_websiteKey'          => 'Sitio web clave', // Field for Buckaroo_Ideal
    'online_payment_secretKey'           => 'Clave secreta', // Field for Buckaroo_Ideal
