...
?>
<br>
<img src="<?= Yii::$app->request->baseUrl; ?><?= Utilities::getPlaceholderRelativeUrl(); ?><?= InvoiceHelper::invoice_logo();?>" height="60" width="60"><br>
<br>
<h6>
<?php
    $pdf_invoice_footer = '';
...
<p> 
    <?php   
            echo Utilities::trans('street_address').":".str_repeat("&nbsp;", 1).$company->address_street."<br>"; 
            ...
            //change frontend\modules\invoice\application\language\English\ip_lang.php
            //zip_code translates as Post code for uk purposes
...
?>
        ...
        <tr>
            ...
            <td class="amount text-right"><?php echo $before.Yii::$app->formatter->asDecimal(!empty($model->salesinvoicetotalpaid) ? $model->salesinvoicetotalpaid : '', 2).$after.$afterspace; ?></td>
        </tr>
        <tr class="overdue">
            <td class="no-bottom-border" colspan="2"></td>
...
<h6><?php
        if (!empty($this->context->mdl_settings->get_setting('default_invoice_terms','',false))) {
          echo $this->context->mdl_settings->get_setting('default_invoice_terms','',false); 
         }
     ?>
</h6>
<br>
<p><?php
       $days = $this->context->mdl_settings->get_setting('invoice_due_after','',false);
       if (!empty($days)) {          
