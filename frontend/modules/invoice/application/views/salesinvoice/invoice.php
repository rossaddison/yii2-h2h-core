...
$js = <<< 'SCRIPT'
    $(function () {
        ...
        $('#email_template').change(function () {
            ...
            $.post("<?php echo Url::to('mailer/get_content'); ?>", {
    ...
    $this->registerJs($js);
?>
<form method="post" action="<?= Url::to(['mailer/send_invoice','invoice_id' => $invoice->invoice_id]); ?>">
            ...
            <div class="col-xs-12 col-md-8 col-md-offset-2">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="subject" id="subject" class="form-control"
                           value="<?=  Utilities::trans('invoice'); ?> #<?php echo $invoice->invoice_number; ?>">
                </div>
