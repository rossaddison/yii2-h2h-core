...
?>
<div class="salesinvoice-uploads-index">
    <div class="page-header">
        <h1><?= Html::encode($this->title) ?></h1>
    </div>

    <p>
        <?php /* echo Html::a('Create Salesinvoice Uploads', ['create'], ['class' => 'btn btn-success'])*/  ?>
    </p>
                ...
                'buttons' => [
                    'update' => function ($url, $model) {
                        return Html::a('<span class="glyphicon glyphicon-pencil"></span>',
                            Yii::$app->urlManager->createUrl(['salesinvoice-uploads/view', 'id' => $model->upload_id, 'edit' => 't']),
