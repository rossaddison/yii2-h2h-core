...
<p> 
    <?php   
            ...
            echo Utilities::trans('zip_code'). ":".str_repeat("&nbsp;", 1).$company->address_areacode."<br>"; 
...
?>
        ...
        <tr>
            ...
            <td class="amount text-right">
                <?php
                   if (!empty($model->salesinvoicetotalpaid)) {
                      echo $before.Yii::$app->formatter->asDecimal($model->salesinvoicetotalpaid, 2).$after.$afterspace;
                   } 
                ?></td>
        </tr>
        <tr class="overdue">
